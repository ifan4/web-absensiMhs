...
if (isset($_POST["submit"])) {
    ...
    $ambil = mysqli_query($koneksi, "SELECT * FROM dosen WHERE nip = '$nip'");
...
<body class="">
    <div class="container col-md-4 col-11 position-absolute top-50 start-50 translate-middle">
        <div class="buletan bg-success d-flex justify-content-center mx-auto">
            <i class="bi bi-person-fill align-self-center"></i>
        </div>
        <h1 class="fs-2 text-center">Login Dosen</h1>
        <!-- <?php //if ($error) : 
                ?>
